    ...
    public class ScarletCore : ModProjectile {
        ...
        public override void AI() {
            ...
            Vector2 _dInsideStaffPos = player.Center + new Vector2(0f, 0f).DirectionFrom(-_mouseToPlayer) * 35f + 
                new Vector2(0f, 0f).DirectionTo(_mouseToPlayer) * _length * StaffDrawing._shootingFactor / new Vector2(Main.screenWidth/60f, Main.screenHeight/40f) + 
                new Vector2(0f, 5f);
            ...
            switch (CurrentAIState) {
                ...
                case AIState.InsideStaff :
                    ...
                    Dust _dInsideStaff = Dust.NewDustPerfect(Projectile.Center, DustID.InfernoFork, Vector2.Zero, 255, Visuals.MasterColor, 1f);
                ...
                case AIState.AboveHead :
                    ...
                    Dust _dAboveHead = Dust.NewDustPerfect(Projectile.Center, DustID.InfernoFork, Vector2.Zero, 255, Visuals.MasterColor, 1f);
